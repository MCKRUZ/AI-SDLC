# Stakeholder Map - Azure Modernization Initiative

**Last Updated**: 2025-11-04 (After Interview 2)  
**Status**: Active Discovery Phase  
**Review Frequency**: After each interview
...
- **Current Stance**: SKEPTIC / BLOCKER
- **Influence on Project**: Can kill funding mid-flight
- **Key Concerns**:
  - SAP failure trauma ($2M write-off)
  - Assumes 3X cost overruns
  - Demands ROI proof before commitment
- **What They Need**:
  - Realistic cost model (not optimistic promises)
  - Clear financial controls and checkpoints
  - Evidence this is different from SAP
  - Demonstrated early wins to build confidence
- **Engagement Strategy**:
  - Interview immediately (Priority 1)
  - Reset expectations on short-term costs
  - Show detailed financial modeling
  - Establish quarterly cost review checkpoints
  - Celebrate financial wins visibly
- **Relationship to Others**:
  - Works closely with CEO on board presentations
  - Skeptical of Michael (new CTO)
  - Respects Sarah's realism
- **Interview Status**: PENDING (Interview 3 - CRITICAL)
...
- **Influence on Project**: Can block if operational concerns not addressed
- **Key Concerns**:
  - Zero tolerance for production downtime ($10K/min)
  - Union relationships and labor harmony
...
- **What They Need**:
  ...
  - Union buy-in and communication plan
  - Operational improvements that benefit factory floor
- **Engagement Strategy**:
  - Interview early (Priority 2)
  - Understand true downtime tolerance
  - Involve in phased migration planning
  - Identify operational quick wins
  - Engage union through Robert's relationship
- **Relationship to Others**:
  - Best friends with CEO (golf buddies)
  - Respects Sarah's expertise
  - Warming to Michael's vision
- **Interview Status**: PENDING (Interview 4)
- **Source**: Interview 1 (Michael), Interview 2 (Sarah)
...
- **Current Stance**: CHAMPION / DRIVER
- **Influence on Project**: Owner, accountable for success
- **Key Concerns**:
  - Board presentation success (30 days)
  - 90-day wins to maintain support
  - PE firm expectations (Stratton Partners)
  - Proving he was right hire
- **What They Need**:
  - Realistic understanding of complexity
  - Sarah's genuine buy-in and support
  - Credible plan to present to board
  - Early wins to build momentum
- **Engagement Strategy**:
  - Align with Sarah on realistic timeline
  - Educate on technical complexity before board presentation
  - Help define achievable 90-day wins
  - Support his success while managing expectations
- **Relationship to Others**:
  - New, still building trust
  - Natural tension with Sarah (change vs. stability)
  - CEO hired him specifically for this
  - CFO is skeptical of him
- **Interview Status**: COMPLETE (Interview 1)
...
- **Current Stance**: CHAMPION (Hired Michael to modernize)
- **Influence on Project**: Can override any blocker, ultimate sponsor
- **Key Concerns**:
  - PE firm (Stratton Partners) expectations
  - Board confidence
  - Can't afford another SAP-style failure
  - Company reputation and competitiveness
- **What They Need**:
  - Confidence this will succeed
  - Assurance it won't blow up like SAP
  - Clear path to PE firm goals
  - No surprises
- **Engagement Strategy**:
  - Keep informed at key milestones
  - Leverage relationship with Robert Turner
  - Present unified executive team view
  - Celebrate wins visibly
- **Relationship to Others**:
  - Hired Michael specifically
  - Best friends with Robert Turner
  - Relies on Jennifer for financial prudence
  - Respects Sarah's experience
- **Interview Status**: NOT SCHEDULED (May not be necessary if Michael aligns)
- **Source**: Interview 1 (Michael)
...
- **Current Stance**: EXPECTANT (Waiting for Michael's plan)
- **Influence on Project**: Approve/reject major funding
- **Key Concerns**:
  - ROI and cost reduction (PE firm metrics)
  - Risk of another SAP failure
  - Competitive position
- **What They Need**:
  - Quarterly updates showing progress
  - Clear metrics and financial impact
  - Confidence in execution
- **Engagement Strategy**:
  - Support Michael's board presentation
  - Provide data for quarterly updates
...
- **Current Stance**: IMPATIENT (Expected progress, behind timeline)
- **Influence on Project**: Can force timeline or changes
- **Key Concerns**:
  - 30% operational efficiency improvement (standard playbook)
  - 3-year ROI window (1 year already elapsed)
  - Portfolio company performance
- **What They Need**:
  - Clear path to efficiency gains
  - Timeline with milestones
  - Risk mitigation plan
- **Engagement Strategy**:
  - Align project goals with PE playbook
  - Show incremental efficiency gains
...
- **Current Stance**: CAUTIOUSLY SUPPORTIVE (Wants change, fears repetition)
- **Influence on Project**: Can enable or passively resist; critical knowledge holder
- **Key Concerns**:
  - Team burnout and attrition
  - Repeating SAP mistakes
  - Timeline unrealistic ("years not quarters")
  - Her role and team's future
  - Short-term costs vs. promised savings
- **What They Need**:
  - Realistic timeline and expectations
  - Protection for her team (no layoffs, training)
  - Her expertise valued and incorporated
  - Ability to build instead of firefight
- **Engagement Strategy**:
  - Treat as KEY PLAYER despite medium power
  - Incorporate her technical reality in all planning
  - Give her ownership of technical decisions
  - Address her team concerns proactively
  - Celebrate her contributions visibly
- **Relationship to Others**:
  - Team trusts her completely
  - Natural tension with Michael (new CTO)
  - CFO respects her realism
  - Robert Turner respects her expertise
- **Interview Status**: COMPLETE (Interview 2)
- **Power Amplification**: Her influence exceeds formal power due to:
  - 15 years institutional knowledge
  - Team loyalty and trust
  - Technical expertise and credibility
  - Ability to passively resist through "technical concerns"
...
- **Current Stance**: LIKELY SUPPORTIVE (Cloud modernizes his role)
- **Influence on Project**: Technical execution, infrastructure expertise
- **Key Concerns**:
  - Hardware EOL crisis (60% of servers past EOL)
  - DR capabilities and gaps
  - Infrastructure costs (on-prem vs. cloud)
- **What They Need**:
  - Clear infrastructure strategy
  - Budget for immediate needs
  - Training on Azure infrastructure
- **Engagement Strategy**:
  - Interview for infrastructure details (Priority 3)
  - Involve in architecture decisions
  - Make him infrastructure workstream lead
- **Interview Status**: PENDING (Interview 5)
- **Source**: Interview 2 (Sarah)
...
- **Current Stance**: UNKNOWN (Likely mixed - opportunity vs. risk)
- **Influence on Project**: Knows black box components and technical debt
- **Key Concerns**:
  - COM+ components with no source code
  - Database dependencies and impacts
  - Maintaining systems during migration
- **What They Need**:
  - Recognition of expertise
  - Involvement in technical decisions
  - Training on modern development
- **Engagement Strategy**:
  - Interview for black box component inventory (Priority 4)
  - Involve in application modernization planning
  - Make him application workstream lead
- **Interview Status**: PENDING (Interview 6)
- **Source**: Interview 2 (Sarah)
...
- **Current Stance**: LIKELY RESISTANT (Protective of factory floor)
- **Influence on Project**: Knows manufacturing systems constraints
- **Key Concerns**:
  - PLC integration fragility (vendor out of business)
  - MES system constraints
  - Factory floor stability
- **What They Need**:
  - Assurance factory floor won't be touched
  - Gradual changes with extensive testing
  - Involvement in any manufacturing IT changes
- **Engagement Strategy**:
  - Interview for manufacturing constraints (Priority 5)
  - Designate shop floor as "Do Not Touch" initially
  - Build abstraction layer for future
- **Interview Status**: PENDING (Interview 7)
- **Source**: Interview 2 (Sarah)
...
- **Current Stance**: MIXED (Younger excited, mid-career pragmatic, senior resistant)
- **Influence on Project**: Can passively resist or actively enable
- **Key Concerns**:
  - Job security despite "no layoffs" promise
  - Learning new skills (Azure, cloud)
  - Leaving legacy systems they know
  - Burnout from migration + BAU
- **What They Need**:
  - Genuine training and support
  - Clear career paths in cloud world
  - Honesty about changes
  - Recognition of past heroics
- **Engagement Strategy**:
  - Comprehensive training program (6 months)
  - Make cloud attractive (resume building)
  - Start with pilot team, expand gradually
  - Celebrate early adopters
- **Segmentation**:
  - **Younger developers**: Excited about cloud, want modern resume
  - **Mid-career pragmatists**: Will adapt if supported
  - **Senior staff**: Resistant, may not adapt
- **Source**: Interview 2 (Sarah)
...
- **Current Stance**: COMFORTABLE WITH STATUS QUO
- **Influence on Project**: Can complain to VP Operations
- **Key Concerns**:
  - System changes affecting production
  - New processes to learn
  - Reliability of systems they depend on
- **What They Need**:
  - Minimal disruption to operations
  - Training on any new tools
  - Advance notice of changes
- **Engagement Strategy**:
  - Keep informed through Robert Turner
  - Pilot changes on non-critical lines first
  - Extensive training before rollout
- **Source**: Interview 1 (Michael)
...
```
                          BOARD
                            |
                          CEO -------- Stratton Partners (PE)
                            |
                    +-------+-------+
                    |               |
                Jennifer (CFO)    Robert (VP Ops) --- Union
                    |               |
                Michael (CTO)       Factory Managers
                    |
                Sarah (IT Dir)
                    |
          +---------+---------+
...
- **Sarah ↔ IT Team**: Deep loyalty and trust
- **Robert ↔ Union**: Established relationship, critical for labor harmony
...
- 🔄 Robert Turner (VP Operations) - Interview 4
- 🔄 Kevin Martinez (Infrastructure) - Interview 5
- 🔄 Raj Patel (Lead Developer) - Interview 6
- 🔄 Lisa Chen (Manufacturing IT) - Interview 7
- ⏳ Union Representative - TBD after Robert interview
- ⏳ Detroit Dynamics (Customer) - Validate SOC 2 requirements
...
- ❌ **CFO starts questioning every cost** → Budget cut imminent
- ❌ **Sarah becomes quiet/withdrawn** → Lost her support
- ❌ **Key IT staff resign** → Knowledge exodus
- ❌ **Robert raises operational concerns** → CEO will hear them
- ❌ **Union representatives ask to meet** → Labor issues brewing
- ❌ **Board requests special briefing** → Confidence shaken
- ❌ **Stratton Partners asks for "update"** → Impatience growing
