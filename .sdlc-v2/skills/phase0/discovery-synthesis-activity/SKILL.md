...
|------|--------|--------|--------|
| Risks in register | ___ | ___ | ☐ |
| Success criteria defined | ___ | ___ | ☐ |
| Hard constraints documented | ___ | ___ | ☐ |
| Soft constraints documented | ___ | ___ | ☐ |
| Stakeholders aligned | ___ | ___ | ☐ |
